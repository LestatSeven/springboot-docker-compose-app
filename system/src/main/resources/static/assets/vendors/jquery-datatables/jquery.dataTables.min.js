...
sNext:"Вперёд",sPrevious:"Назад"},sEmptyTable:"Нет доступных данных",sInfo:"Показано с _START_ по _END_ из _TOTAL_ записей",sInfoEmpty:"Показано с 0 по 0 из 0 записей",sInfoFiltered:"(выбрано из _MAX_ записей всего)",sInfoPostFix:"",sDecimal:"",sThousands:",",sLengthMenu:"Показать _MENU_ записей",sLoadingRecords:"Загрузка...",sProcessing:"Обработка...",sSearch:"Поиск:",sSearchPlaceholder:"",sUrl:"",sZeroRecords:"Не найдено подходящих записей"},oSearch:l.extend({},u.models.oSearch),sAjaxDataProp:"data",
